...
The patched protocol achieves no attack-induced PDR degradation
...
machine-checked vulnerability proofs, proposed a formally verified
patch, or validated the result across multi-topology simulation and
physical hardware for any LoRa ad~hoc mesh routing protocol.
...
EoRa-PI boards confirms no attack-induced PDR degradation and—
